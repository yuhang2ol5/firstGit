...
public class JMine extends JFrame implements MouseListener, ActionListener {
	...
	private ImageIcon[] mineNumIcon = { new ImageIcon(JMine.class.getResource("blank1.gif")),
			new ImageIcon(JMine.class.getResource("1.gif")), new ImageIcon(JMine.class.getResource("2.gif")),
			new ImageIcon(JMine.class.getResource("3.gif")), new ImageIcon(JMine.class.getResource("4.gif")),
			new ImageIcon(JMine.class.getResource("5.gif")), new ImageIcon(JMine.class.getResource("6.gif")),
			new ImageIcon(JMine.class.getResource("7.gif")), new ImageIcon(JMine.class.getResource("8.gif")),
			new ImageIcon(JMine.class.getResource("0.gif"))};

	private ImageIcon[] mineStatus = { new ImageIcon(JMine.class.getResource("blank1.gif")),
			new ImageIcon(JMine.class.getResource("flag.gif")), new ImageIcon(JMine.class.getResource("question.gif")) };

	private ImageIcon[] mineBombStatus = { new ImageIcon(JMine.class.getResource("0.gif")),
			new ImageIcon(JMine.class.getResource("mine.gif")), new ImageIcon(JMine.class.getResource("wrongmine.gif")),
			new ImageIcon(JMine.class.getResource("bomb.gif")) };

	private ImageIcon[] faceIcon = { new ImageIcon(JMine.class.getResource("smile.gif")),
